/*
 * @fileoverview    {InterlocutoresComercialesController}
 *
 * @version         2.0
 *
...
namespace Almacen.Controllers {
    ...
    /**
     * TODO: Description of {@code InterlocutoresComercialesController}.
     *
     * @author Dyson Parra
    ...
    public class InterlocutoresComercialesController : Controller {
        ...
        public async Task<IActionResult> Details(long? id) {
            ...
            var interlocutoresComerciales = await _context.InterlocutoresComerciales
                .FirstOrDefaultAsync(m => m.IntIdInterlocutorComercial == id);
            if (interlocutoresComerciales == null) {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("IntIdInterlocutorComercial,StrCodigoInterlocutor,StrNumeroIdentificacionFinanciera,StrNombreInterlocutor,StrTelefono,StrCelular,StrFax,StrEmail,StrUsuario,DtFecha,IntIdGrupoInterlocutor,IntIdTipoInterlocutor")] InterlocutoresComerciales interlocutoresComerciales) {
            if (ModelState.IsValid) {
                _context.Add(interlocutoresComerciales);
        ...
        public async Task<IActionResult> Edit(long? id) {
            ...
            var interlocutoresComerciales = await _context.InterlocutoresComerciales.FindAsync(id);
            if (interlocutoresComerciales == null) {
                return NotFound();
            }
            return View(interlocutoresComerciales);
        ...
        public async Task<IActionResult> Edit(long? id, [Bind("IntIdInterlocutorComercial,StrCodigoInterlocutor,StrNumeroIdentificacionFinanciera,StrNombreInterlocutor,StrTelefono,StrCelular,StrFax,StrEmail,StrUsuario,DtFecha,IntIdGrupoInterlocutor,IntIdTipoInterlocutor")] InterlocutoresComerciales interlocutoresComerciales) {
            if (id != interlocutoresComerciales.IntIdInterlocutorComercial) {
                return NotFound();
            }

            if (ModelState.IsValid) {
                try {
                    _context.Update(interlocutoresComerciales);
                    await _context.SaveChangesAsync();
                }
                catch (DbUpdateConcurrencyException) {
                    if (!InterlocutoresComercialesExists(interlocutoresComerciales.IntIdInterlocutorComercial)) {
                        return NotFound();
                    }
                    else {
                        throw;
        ...
        public async Task<IActionResult> DeleteConfirmed(long? id) {
            if (_context.InterlocutoresComerciales == null) {
                return Problem("Entity set 'AlmacenContext.InterlocutoresComerciales'  is null.");
            }
            var interlocutoresComerciales = await _context.InterlocutoresComerciales.FindAsync(id);
            if (interlocutoresComerciales != null) {
                _context.InterlocutoresComerciales.Remove(interlocutoresComerciales);
            }
